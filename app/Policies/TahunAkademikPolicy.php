...
class TahunAkademikPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, TahunAkademik $tahunAkademik)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, TahunAkademik $tahunAkademik)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, TahunAkademik $tahunAkademik)
    {
        //
    }
}
